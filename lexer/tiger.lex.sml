...
fun yyQ115 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction4(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ116(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
...
fun yyQ114 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction4(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"/"
              then yyQ117(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
              else yyAction4(strm, yyNO_MATCH)
      (* end case *))
            ...
            if inp = #"]"
              ...
              then if inp = #"0"
                  ...
                  then if inp = #"2"
                      ...
                      else yyQ102(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
                else if inp = #"\\"
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ52(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyAction48(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ47(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ47(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ85(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyAction48(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ89(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ47(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyAction48(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ23 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ94(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
