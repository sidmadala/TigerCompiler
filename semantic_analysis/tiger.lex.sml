...
fun yyAction64 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (YYBEGIN STRING; ErrorMsg.error yypos ("illegal character (none-whitespace) in formating sequence: " ^ yytext); continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction48(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ73(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyAction48(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction20(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #"_"
                  then yyQ68(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ68(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction18(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction18(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ68(strm', yyMATCH(strm, yyAction18, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction19(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ106(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyAction48(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ68(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ68(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction48(strm, yyNO_MATCH)
                  else yyQ110(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ68(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
              else yyAction48(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ44 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction25(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ115(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
...
fun yyQ42 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ117(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"]"
              ...
              then if inp = #"0"
                  ...
                  then if inp = #"\""
                      then yyQ13(strm', yyMATCH(strm, yyAction57, yyNO_MATCH))
